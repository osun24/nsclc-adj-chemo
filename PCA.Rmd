...
GPL96.data$`Smoked?` <- ifelse(GPL96.data$`Smoked?` == 1, "Yes",
                             ifelse(GPL96.data$`Smoked?` == 0, "No", "Unknown"))
GPL96.data$`Smoked?`[is.na(GPL96.data$`Smoked?`)] <- "Unknown"
GPL96.data$IS_MALE <- GPL96.data$Sex
...
unique(all.data$IS_MALE)
unique(GPL570_96.data$IS_MALE)
GPL570_96.data$Stage[GPL570_96.data$Stage == "I"  ] <- "IA"
GPL570_96.data$Stage[GPL570_96.data$Stage == "IIIA"  ] <- "III"
GPL570_96.data$Stage[GPL570_96.data$Stage == "IIIB"  ] <- "III"
GPL570_96.data$Stage[GPL570_96.data$Stage == "IIA"  ] <- "II"
GPL570_96.data$Stage[GPL570_96.data$Stage == "IIB"  ] <- "II"
GPL570_96.data$Stage[is.na(GPL570_96.data$Stage)] <- "Unknown"
GPL570_96.data$Sex <- NULL
GPL570_96.data$Histology[GPL570_96.data$Histology == "Large Cell Undifferentiated Carcinoma"] <- "Large Cell Carcinoma"
GPL570_96.data$Histology[is.na(GPL570_96.data$Histology)] <- "Unknown"
GPL570_96.data$Race[GPL570_96.data$Race == "White"  ] <- "Caucasian"
GPL570_96.data$Race[GPL570_96.data$Race == "Black or African American"  ] <- "African American"

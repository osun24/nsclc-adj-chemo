...
affy.data = bind_rows(GSE29013.data, GSE37745.data, GSE50081.data, GSE31908.data, GSE31210.data, GSE68465.data, GSE14814.data)
...
ggplot(pca_df, aes(x = PC1, y = PC2, color = Batch)) +
  ...
  coord_cartesian(xlim = range(pca_df$PC1), ylim = range(pca_df$PC2))
...
ggplot(pca_after_df, aes(x = PC1, y = PC2, color = Batch)) +
  ...
  coord_cartesian(xlim = range(pca_after_df$PC1), ylim = range(pca_after_df$PC2))

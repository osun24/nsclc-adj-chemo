...
GSE31908.data = GSE31908.data[, c(1, 5, 8, 10, 13, 15, 17)]

# Next, we want to append clinical information onto gene expression data
colnames(GSE31908.data) = c("Adjuvant Chemo", "Sex", "PFS_MONTHS", "OS_MONTHS", "Race", "Smoked?", "OS_STATUS")
...
GSE31908.expr = GSE31908merged[, -c(1:7)]

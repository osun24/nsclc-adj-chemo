...
GSE31908.data$Age = c(73, 69, 67, 67, 67, 59, 74, 65, 73, 73, 65, 73, 65, 69, 62, 67)

# Next, we want to append clinical information onto gene expression data
colnames(GSE31908.data) = c("Adjuvant Chemo", "Sex", "PFS_MONTHS", "OS_MONTHS", "Stage","Race", "Smoked?", "OS_STATUS", "Histology", "Age")
...
GSE31908data.expr = GSE31908merged[, 1:7]
``` 

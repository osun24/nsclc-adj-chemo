...
feature.dat = 
  gse$GSE39279_series_matrix.txt.gz@featureData@data
...
colnames(GSE39279.data) = c("Adjuvant Chemo", "Age", "Status (as of 6/11)", "Gender", "Intraoperative Brachtherapy", "Years Quit", "Overall Survival (as of 6/11)", "Packyear", "Smoking Status", "TNM 7th Ed. Stage")

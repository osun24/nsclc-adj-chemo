...
probes31908 = colnames(GSE31210.expr)
...
GSE31210.data = GSE31210.data[, c(1, 7, 9, 15, 18, 20, 21)]
...
colnames(GSE31210.data) = c("Age", "OS_STATUS", "Sex", "Stage", "Smoked?", "OS_MONTHS", "Histology")

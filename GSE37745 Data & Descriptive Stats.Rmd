...
write.csv(feature.df, 
          "~/Downloads/GSE37745symbol.csv", 
          row.names = F)

gset = getGEO("GSE37745", GSEMatrix=T, getGPL=F)
if (length(gset) > 1) 
...
write.csv(GSE37745.symbol, 
          "~/Downloads/GSE37745_symbol.csv")

write.csv(gse37745.data, 
          file = "~/Downloads/GSE37745_data.csv")
```

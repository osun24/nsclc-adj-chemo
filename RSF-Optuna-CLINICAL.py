...
def compare_treatment_recommendation_km_rsf(model, df, genes_main, genes_inter, dup_inter,
                                           clin_cols,
                                           time_col="OS_MONTHS", event_col="OS_STATUS", folder =""):
    ...
    plt.tight_layout()
    plt.savefig(f"{folder}km_alignment_rsf_recommendation.png", dpi=600)
    plt.show()
...
# ---- Run study ----
storage = "sqlite:///rsf_optuna_jan25_CLINICAL.db"
study_name = "rsf_jan_25_CLINICAL_1se"
